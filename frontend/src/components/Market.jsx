  ...
  return (
    <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto min-h-screen bg-[#F9FAFB]/50">
      ...
      <div className="relative overflow-hidden bg-white/40 backdrop-blur-xl border border-white/60 rounded-[2.5rem] p-8 shadow-2xl shadow-green-900/5">
        ...
        {/* Animated City Selector with Search */}
        <AnimatePresence>
          {showCitySelector && (
            <motion.div
              ...
              <div className="mb-6">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 rounded-2xl border-2 border-gray-200 focus:border-green-500 focus:outline-none text-lg"
                    autoFocus
                  />
                </div>
                <p className="text-xs text-gray-400 mt-2 ml-2">Type at least 2 characters to search</p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-6 max-h-96 overflow-y-auto">
                  {allCities.map((city, index) => (
                    ...
                    >
                      ...
                      <div className="text-[10px] text-gray-400 group-hover:text-green-100 uppercase tracking-widest font-black transition-colors">
